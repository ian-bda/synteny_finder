...
if __name__ == '__main__':
    ...
    gff_files = sorted([f for f in os.listdir(GFF_DIR) if f.endswith('.gff3.gz') or f.endswith('.gff3')])
    cds_files = sorted([f for f in os.listdir(ORIG_CDS_DIR) if f.endswith('.fa.gz') or f.endswith('.fa')])
    species_info = {}
    id_to_name_map = {}
